...
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: poison_options.sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: poison_options.sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: poison_options.sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: poison_options.sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: poison_options.sample, days_after_rain_til_growth: rand(1..5))
...
Mushroom.create(name: "Morel", habitat: "mixed forest", edible?: true, poisonous?: "not", days_after_rain_til_growth: 3)
Mushroom.create(name: "Chanterelle", habitat: "coniferous forest", edible?: true, poisonous?: "not", days_after_rain_til_growth: 4)
