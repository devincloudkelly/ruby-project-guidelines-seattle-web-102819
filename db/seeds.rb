...
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: [true, false].sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: [true, false].sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: [true, false].sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: [true, false].sample, days_after_rain_til_growth: rand(1..5))
Mushroom.create(name: Faker::Ancient.unique.primordial, habitat: habitat_options.sample, edible?: [true, false].sample, poisonous?: [true, false].sample, days_after_rain_til_growth: rand(1..5))
...
Mushroom.create(name: "Chanterelle", habitat: "coniferous forest", edible?: true, poisonous?: false, days_after_rain_til_growth: 4)
